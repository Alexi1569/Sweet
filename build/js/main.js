  ...
  (function initMenu() {
    ...
    $toggler.click(function() {
      ...
      if ($toggler.hasClass('active')) {
        ...
        tl.fromTo($bottom, .5, {autoAlpha: 1, y: 0}, {autoAlpha: 0, y: 50, onStart: function() {
            $toggler.addClass('disabled');
            $menu.css('padding-right', '0px');
            $('body').removeClass('no-scroll');
            window.scrollTo(0, topOffset);
          }})
          .staggerFromTo(liItems, .35, {autoAlpha: 1, y: 0}, {autoAlpha: 0, y: 20}, -0.15, '-=.35')
          .fromTo($bg, .9, {autoAlpha: 1, webkitClipPath: 'circle(150% at 0 0)'}, {autoAlpha: 0, webkitClipPath: 'circle(' + beginPath[0] + ' at ' + beginPath[1] + ' ' + beginPath[2] + ')', onComplete: function() {
              $toggler.removeClass('disabled');
